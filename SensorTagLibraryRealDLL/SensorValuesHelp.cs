   ...
   public class SensorValuesHelp
    {
        ...
        private static async void StartSenser()
        {          
        ...
        static AccelerometerMeasurement measurement;
        static MovementMeasurement movement;

        private static void OnAccelerometerMeasurementValueChanged(object sender, AccelerometerMeasurementEventArgs e)
        {
            measurement = e.Measurement;            
        }

        static void OnMovementMeasurementValueChanged(object sender, MovementEventArgs e)
        {
